...
- Currently-trained property pairs: `lipid_packing` + `thickness` (PR #3 sweep default). The multi-target `out_dim` of `MembranePropertyGNN` equals `len(properties)`; any subset of the 8 can be selected via `preprocess_graphs.py --properties ...`
